	...
	extends IncludableSpecialPage
{
	...
	public function execute( $parameters ) {
		...
		if ( $feedFormat ) {
			...
			$pager = new TeaserPager($query, $opts['limit'], $this->including());
			
			$articleList = $pager->getBody();
			
			$content = Xml::wrapClass( $articleList, 'wl-wrapper', 'div' );
